# 🌳 Machine Learning & Quantitative Finance Architecture Notes

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Obsidian](https://img.shields.io/badge/Vault-Obsidian-purple.svg)](https://obsidian.md/)
[![Code Style: Production](https://img.shields.io/badge/Code%20Style-Production-green.svg)]()
...
1. Clone this repository directly onto your local system:
   ```bash
   git clone [https://github.com/shipitdev/ml-notes.git](https://github.com/shipitdev/ml-notes.git)
   ```
